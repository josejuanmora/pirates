...
CREATE UNIQUE INDEX UX_GOODS_ID ON GOODS (ID);
...
CREATE INDEX IX_GOODS_01 ON GOODS (EVENT_ID);
ALTER TABLE GOODS ADD CONSTRAINT FK_GOODS_01 FOREIGN KEY (EVENT_ID) REFERENCES EVENTS (ID);
