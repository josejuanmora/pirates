...
(
  ...
  BARRELS_OF_RUM    INT                 CONSTRAINT NN_EVENTS_BOR NOT NULL,
  GOLD_COINS        INT                 CONSTRAINT NN_EVENTS_GC NOT NULL,
...
COMMENT ON COLUMN EVENTS.BARRELS_OF_RUM is 'The number of barrels of rum that the ship is transporting at the time of the event';
COMMENT ON COLUMN EVENTS.GOLD_COINS is 'The number of gold coins that the ship is transport at the time of the event';
